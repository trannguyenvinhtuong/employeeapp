...
class Navcp extends Component{
    render() {
        return (
            <header>
                <Link to="/">
                    <i className="fas fa-bars" style={{paddingRight:'.5rem', color:'#9d3d6b', fontWeight:'bolder', fontSize:'2rem'}}></i>
                    penske
                </Link>
                <div>
                ...
                <nav>    
                    ...
                    <a href="#" className="name-user">
                        jean valjean
                        <i className="fas fa-chevron-down" style={{paddingLeft:'.5rem'}}></i>
                    </a>
                </nav>
            </header>
        );
